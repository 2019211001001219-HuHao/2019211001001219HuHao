		...
		<div class="table-responsive col-sm-10">
			<table class="table table-condensed">
				...
				<tr>
					...
					<td>${o.orderDate}</td>
					<%
						com.HuHao.model.Order o=(com.HuHao.model.Order)pageContext.findAttribute("o");
						int userId=o.getCustomerId();
						java.sql.Connection con=(java.sql.Connection)application.getAttribute("dbConn");
						com.HuHao.dao.UserDao userDao=new com.HuHao.dao.UserDao();
					...
					<td class="cart_total">${o.paymentId}
						<%
							...
							String paymentType=com.HuHao.model.Payment.findByPaymentId(con,n);
						%>
